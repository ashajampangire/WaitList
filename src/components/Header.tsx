...
export const Header: React.FC<HeaderProps> = ({ className, logoSize }) => {
  return (
        ...
        <Link to="/" className="flex items-center">
          <div className="relative top-4 left-4">
            <img 
              ...
              alt="NEFTIT Logo" 
              className={`${logoSize ? logoSize : 'h-10 md:h-12'} object-contain transition-transform hover:scale-110 drop-shadow-[0_0_16px_rgba(93,67,239,0.7)]`} 
            />
          </div>
        </Link>
      </div>
