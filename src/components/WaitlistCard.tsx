...
const WaitlistCard = ({ icon, title, subtitle, completed, onClick, className = "" }: WaitlistCardProps) => {
  return (
    <Card 
      className={`bg-[url(assets/images/back.png)] bg-cover bg-center bg-no-repeat backdrop-blur-sm border border-[#5D43EF EDEAFF] rounded-2xl p-5 px-8 cursor-pointer transition-all duration-300 hover:bg-[#080420]/90 hover:border-[#5D43EF EDEAFF] ${
